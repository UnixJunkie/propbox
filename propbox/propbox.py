...
# Descriptor calculations can take place locally in a single thread,
# or in multiple threads, or in an external co-process, or remotely
# over the network.
